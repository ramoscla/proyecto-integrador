...
let nodo_h6 = document.querySelector('section h6') // Artista
let nodo_p = document.querySelector('section p') // Album
...
fetch(proxy + url)
    ...
    .then(function(datos) {
        ...
        nodo_h6.textContent = datos.artist.name
        nodo_p.textContent = datos.album.title
